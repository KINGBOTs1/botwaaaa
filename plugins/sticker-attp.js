...
let handler = async (m, { conn, args, text, usedPrefix, command }) => {
    ...
    const res = `https://botcahx.ddns.net/api/maker/attp?text=${encodeURIComponent(text)}`
    const res2 = `https://botcahx.ddns.net/api/maker/ttp?text=${encodeURIComponent(text)}`
